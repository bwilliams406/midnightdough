...
exports.onOrderUpdated = exports.onOrderCreated = exports.sendNotificationEmail = exports.sendStatusUpdateEmail = exports.sendOrderEmail = void 0;
...
function generateCustomerStatusEmail(order) {
...
function generateAdminStatusEmail(order) {
    const statusLabels = {
        pending: 'Pending',
        processed: 'Confirmed',
...
function generateAdminNotificationEmail(title, message, severity) {
...
exports.sendOrderEmail = (0, https_1.onRequest)({ secrets: [resendApiKey], cors: true }, async (req, res) => {
    if (req.method !== 'POST') {
...
exports.sendStatusUpdateEmail = (0, https_1.onRequest)({ secrets: [resendApiKey], cors: true }, async (req, res) => {
    if (req.method !== 'POST') {
        res.status(405).send('Method Not Allowed');
        return;
    }
...
exports.sendNotificationEmail = (0, https_1.onRequest)({ secrets: [resendApiKey], cors: true }, async (req, res) => {
    if (req.method !== 'POST') {
        res.status(405).send('Method Not Allowed');
        return;
    }
...
exports.onOrderCreated = (0, firestore_1.onDocumentCreated)({ document: 'orders/{orderId}', secrets: [resendApiKey] }, async (event) => {
    var _a, _b, _c, _d, _e, _f;
    const snapshot = event.data;
    if (!snapshot)
        return;
    const order = snapshot.data();
    if (!order || !((_a = order.customer) === null || _a === void 0 ? void 0 : _a.email)) {
    ...
    const orderData = {
        ...
        deliveryFee: ((_b = order.delivery) === null || _b === void 0 ? void 0 : _b.fee) || 0,
        tax: order.tax || 0,
        tip: order.tip || 0,
        total: order.total || 0,
        deliveryAddress: {
            address: ((_c = order.delivery) === null || _c === void 0 ? void 0 : _c.address) || '',
            city: ((_d = order.delivery) === null || _d === void 0 ? void 0 : _d.city) || '',
            state: ((_e = order.delivery) === null || _e === void 0 ? void 0 : _e.state) || '',
            zip: ((_f = order.delivery) === null || _f === void 0 ? void 0 : _f.zip) || ''
        },
...
exports.onOrderUpdated = (0, firestore_1.onDocumentUpdated)({ document: 'orders/{orderId}', secrets: [resendApiKey] }, async (event) => {
    ...
    if (!((_c = after.customer) === null || _c === void 0 ? void 0 : _c.email)) {
        console.log('No customer email, skipping');
        return;
    }
    const resend = new resend_1.Resend(resendApiKey.value());
    const orderData = {
        ...
        deliveryFee: ((_d = after.delivery) === null || _d === void 0 ? void 0 : _d.fee) || 0,
        tax: after.tax || 0,
        tip: after.tip || 0,
        total: after.total || 0,
        deliveryAddress: {
            address: ((_e = after.delivery) === null || _e === void 0 ? void 0 : _e.address) || '',
            city: ((_f = after.delivery) === null || _f === void 0 ? void 0 : _f.city) || '',
            state: ((_g = after.delivery) === null || _g === void 0 ? void 0 : _g.state) || '',
            zip: ((_h = after.delivery) === null || _h === void 0 ? void 0 : _h.zip) || ''
        },
        status: after.status,
